...
.get((req,res)=> {
    res.end("Will send all the partners to you");  //Just shows that we can access this code for now
})
.post((req,res) => {
...
//Adding a new Express Router for the /:partnerId route parameter
